...
for x in txt:
    s = x.split('/')[-1]
    if(s[-7:-4] != "_tb" and s != "tech_memory_ram_crwk_crw.vhd" and s != "common_ram_crw_crw_ratio.vhd" and s!= "altera_mf.vhd" and s!="altera_mf_components.vhd"
    and s!= "ip_stratixiv_ram_cr_cw.vhd" and s!= "ip_stratixiv_ram_crw_crw.vhd" and s!= "ip_stratixiv_ram_crwk_crw.vhd"):
