...
# XPM Library compile
lib_xpm = vu.add_library("xpm","2002")
...
# Altera_mf library
lib_altera_mf = vu.add_library("altera_mf","2002")
...
ip_xpm_mult_lib = vu.add_library("ip_xpm_mult_lib","2002", allow_duplicate=True)
...
ip_stratixiv_mult_lib = vu.add_library("ip_stratixiv_mult_lib","2002", allow_duplicate=True)
...
# XPM RAM library
ip_xpm_ram_lib = vu.add_library("ip_xpm_ram_lib","2002")
...
ip_stratixiv_ram_lib = vu.add_library("ip_stratixiv_ram_lib","2002")
...
common_components_lib = vu.add_library("common_components_lib","2002")
...
common_pkg_lib = vu.add_library("common_pkg_lib","2002")
...
# DP PACKAGE Library
dp_pkg_lib = vu.add_library("dp_pkg_lib","2002")
dp_pkg_lib.add_source_file(join(script_dir, "../casper_dp_pkg/dp_stream_pkg.vhd"))

# DP COMPONENTS Library
dp_components_lib = vu.add_library("dp_components_lib","2002")
...
casper_multiplier_lib = vu.add_library("casper_multiplier_lib","2002")
...
casper_multiplexer_lib = vu.add_library("casper_multiplexer_lib","2002")
...
casper_requantize_lib = vu.add_library("casper_requantize_lib","2002")
...
# CASPER RAM Library
casper_ram_lib = vu.add_library("casper_ram_lib","2002")
...
casper_filter_lib = vu.add_library("casper_filter_lib","2002")
...
# CASPER MEM Library
casper_mm_lib = vu.add_library("casper_mm_lib","2002")
casper_mm_lib.add_source_file(join(script_dir, "../casper_mm/tb_common_mem_pkg.vhd"))

# CASPER SIM TOOLS Library
casper_sim_tools_lib = vu.add_library("casper_sim_tools_lib","2002")
...
wb_fft_lib = vu.add_library("wb_fft_lib","2002")
...
wpfb_lib = vu.add_library("wpfb_lib","2002")
