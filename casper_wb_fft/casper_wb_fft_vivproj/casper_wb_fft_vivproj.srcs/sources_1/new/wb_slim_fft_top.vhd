...
architecture RTL of wideband_fft_top is
        ...
        signal in_bb_sosi_arr : t_fft_sosi_arr_in(wb_factor - 1 downto 0);
        signal out_bb_sosi_arr : t_fft_sosi_arr_out(wb_factor - 1 downto 0);
        ...
        in_fft_sosi_arr  => in_bb_sosi_arr,
        ovflw => out_ovflw,
        out_fft_sosi_arr => out_bb_sosi_arr);
