...
lib.add_source_files("/mnt/c/Users/mybur/Work/xpm_vhdl/src/xpm/xpm_VCOMP.vhd")
lib.add_source_files("/mnt/c/Users/mybur/Work/xpm_vhdl/src/xpm/xpm_memory/hdl/*.vhd")

lib0 = vu.add_library("altera_mf")
lib0.add_source_files(os.path.join(script_dir,"../altera/*.vhd"))
...
lib6.add_source_files(script_dir + "/../technology/technology_select_pkg.vhd")
