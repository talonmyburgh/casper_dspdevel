...
ip_stratix_source_files = lib5.add_source_files(os.path.join(script_dir, "../ip_stratixiv/ram/*.vhd"))
for ip_stratix_source_file in ip_stratix_source_files:
	ip_stratix_source_file.add_dependency_on(altera_mf_source_file)
