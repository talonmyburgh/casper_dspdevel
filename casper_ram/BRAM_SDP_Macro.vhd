...
generic (
    ...
    DO_REG : integer := 0; -- Number of pipeline registers at output of block ram
...
port (
    ...
    DO : out std_logic_vector(READ_WIDTH-1 downto 0); -- Data Output Bus	
    DI : in std_logic_vector(WRITE_WIDTH-1 downto 0); -- Data Output Parity Bus
    RDADDR : in std_logic_vector; -- Read Data Address Bus
    RDCLK : in std_ulogic; -- Read Data Clock
    RDEN : in std_ulogic; -- Read Port Enable
    REGCE : in std_ulogic; -- Output Register Clock Enable
    RST : in std_ulogic; -- Reset
    WE : in std_logic_vector; -- Byte-wide Write Enable
    WRADDR : in std_logic_vector; -- Write Data Address Bus
    WRCLK : in std_ulogic; -- Write Data Clock
    WREN : in std_ulogic -- Write Port Enable
