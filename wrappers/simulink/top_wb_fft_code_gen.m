...
%--------------------------------------------------------------------------------%
function vhdlfile = top_wb_fft_code_gen(wb_factor,nof_points,twid_dat_w,vendor, in_dat_w, out_dat_w, stage_dat_w)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%prtdec%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    lnsuptoportdec = ["library ieee,casper_wb_fft_lib, r2sdf_fft_lib, common_pkg_lib;"
